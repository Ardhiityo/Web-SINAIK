...
@section('title', 'Edit Sidang Skripsi/TA')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="overflow-auto card">
                                    <form
                                        action="{{ route('final-projects.update', ['final_project' => $finalProject->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required type="date" class="form-control" id="session_date"
                                                        name="session_date"
                                                        value="{{ old('session_date', $finalProject->raw_session_date) }}">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required type="time" name="session_time" class="form-control"
                                                        ...
                                                        value="{{ old('session_time', $finalProject->session_time) }}">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="student_id" required name="student_id" class="form-control">
                                                        ...
                                                        @foreach ($students as $student)
                                                            <option value="{{ $student->id }}"
                                                                {{ old('student_id', $finalProject->student->id) == $student->id ? 'selected' : '' }}>
                                                                {{ $student->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                    ...
                                                    <select required id="lecture_1_id" name="lecture_1_id"
                                                        ...
                                                        @foreach ($lectures as $lecture)
                                                            <option value="{{ $lecture->id }}"
                                                                {{ old('lecture_1_id', $finalProject->student->lecture_1_id) == $lecture->id ? 'selected' : '' }}>
                                                                {{ $lecture->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                    ...
                                                    <select required id="academic_calendar_id" name="academic_calendar_id"
                                                        ...
                                                        @foreach ($academicCalendars as $academicCalendar)
                                                            <option value="{{ $academicCalendar->id }}"
                                                                {{ old('academic_calendar_id', $finalProject->academic_calendar_id) == $academicCalendar->id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select required id="lecture_2_id" name="lecture_2_id"
                                                        ...
                                                        @foreach ($lectures as $lecture)
                                                            <option value="{{ $lecture->id }}"
                                                                {{ old('lecture_2_id', $finalProject->student->lecture_2_id) == $lecture->id ? 'selected' : '' }}>
                                                                {{ $lecture->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                    ...
                                                    <select required id="room_id" name="room_id" class="form-control">
                                                        ...
                                                        @foreach ($rooms as $room)
                                                            <option value="{{ $room->id }}"
                                                                {{ old('room_id', $finalProject->room_id) == $room->id ? 'selected' : '' }}>
                                                                {{ $room->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select required id="examiner_1_id" name="examiner_1_id"
                                                        ...
                                                        @foreach ($lectures as $lecture)
                                                            <option value="{{ $lecture->id }}"
                                                                {{ old('examiner_1_id', $finalProject->examiner_1_id) == $lecture->id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="moderator_id" name="moderator_id" class="form-control">
                                                        <option selected value="">Choose...</option>
                                                        @foreach ($lectures as $lecture)
                                                            <option value="{{ $lecture->id }}"
                                                                {{ old('moderator_id', $finalProject->moderator_id) == $lecture->id ? 'selected' : '' }}>
                                                                {{ $lecture->name }} - {{ $lecture->nidn }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select required id="examiner_2_id" name="examiner_2_id"
                                                        ...
                                                        @foreach ($lectures as $lecture)
                                                            <option value="{{ $lecture->id }}"
                                                                {{ old('examiner_2_id', $finalProject->examiner_2_id) == $lecture->id ? 'selected' : '' }}>
                                                                {{ $lecture->name }} - {{ $lecture->nidn }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
