                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="overflow-auto card">
                                    <form
                                        action="{{ route('link-productive.umkms.biodata.update', ['umkm' => $umkm->id, 'biodata' => $umkm->biodata->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required type="name" class="form-control" id="business_name"
                                                        ...
                                                        value="{{ old('business_name', $umkm->biodata->business_name) }}">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="business_description">Deskripsi Bisnis</label>
                                                    <textarea name="business_description" class="form-control">{{ old('business_description', $umkm->biodata->business_description) }}</textarea>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="business_scale_id" required name="business_scale_id"
                                                        ...
                                                        @foreach ($businessScales as $businessScale)
                                                            <option value="{{ $businessScale->id }}"
                                                                {{ old('business_scale_id', $umkm->biodata->business_scale_id) == $businessScale->id ? 'selected' : '' }}>
                                                                {{ $businessScale->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select id="certification_id" required name="certification_id"
                                                        ...
                                                        @foreach ($certifications as $certification)
                                                            <option value="{{ $certification->id }}"
                                                                {{ old('certification_id', $umkm->biodata->certification_id) == $certification->id ? 'selected' : '' }}>
                                                                {{ $certification->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required type="date" class="form-control" id="founding_year"
                                                        name="founding_year"
                                                        value="{{ old('founding_year', $umkm->biodata->founding_year->format('Y-m-d')) }}">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="city">Kota</label>
                                                    <input required type="text" class="form-control" id="city"
                                                        name="city" value="{{ old('city', $umkm->biodata->city) }}"
                                                        placeholder="Cilegon">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required type="text" class="form-control" id="province"
                                                        name="province"
                                                        value="{{ old('province', $umkm->biodata->province) }}"
                                                        placeholder="Banten">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="address">Alamat Lengkap</label>
                                                    <textarea name="address" class="form-control" rows="10" cols="50">{{ old('address', $umkm->biodata->address) }}</textarea>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="phone_number">Telepon</label>
                                                    <input required type="text" class="form-control" id="phone_number"
                                                        name="phone_number"
                                                        value="{{ old('phone_number', $umkm->biodata->phone_number) }}"
